...
import { DownOutlined,ArrowRightOutlined ,UserOutlined,
...
const HeadingCal = () => {
  return (
   ...
   <p className="text-[#8f8fb8]">Premiun Access</p>
      <h2 className="text-3xl font-bold">Take Back <br/>Your Creative <br/>Control   <Avatar.Group>
      ...
      <div className="flex border-2 px-2  rounded-xl py-2  text-left justify-between mt-4 mb-8" >
